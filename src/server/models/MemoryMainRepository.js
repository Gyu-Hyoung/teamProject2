...
let tour = [
  ...
  },
  {
    ...
    category : "tour",
    charater : ["관광명소", "자연휴양", "가족여행", "풍경", "참꽃축제"]
  },
  {
    no : 3,
    name : "앞산전망대",
  ...
  },
  {
    ...
    category : "tour",
    charater : ["관광명소", "전통시장", "다양한 상품", "흥미유발"]
  },
  {
    no : 6,
    name : "에코테마파크 대구 숲",
    ...
    category : "tour",
    charater : ["관광명소", "자연휴양", "가족여행", "여유로움", "익사이팅"]
  }
];
let food = [
    {
      ...
      category : "food",
      charater : ["생선요리", "분위기 좋음", "가족식사", "매콤함", "맛집"]
    },
    {
      no : 2,
      name : "대동강",
    ...
    },
    {
      ...
      category : "food",
      charater : ["이열치열", "밥 도둑", "소주 한잔", "매콤함", "생선요리"]
    },
    {
      no : 4,
      name : "금곡삼계탕",
      ...
      category : "food",
      charater : ["뜨끈함", "닭요리", "시원한 국물", "보양식", "계절별미"]
    },
    {
      no : 5,
      name : "미림",
    ...
    },
    {
      ...
      category : "food",
      charater : ["육류 고기", "대구 맛집", "갈매기 살", "회식", "옛날 감성"]
    }
];
...
let festival = [
  {
    ...
    category : "festival",
    charater : ["로맨틱", "꽃과 별빛", "겨울한정", "1월중", "엔젤로드"]
  },
  {
    no : 2,
    name : "비슬산참꽃문화제",
    ...
    category : "festival",
    charater : ["참꽃 가요제", "반딧불이 버스킹", "댄스퍼레이드", "4월중", "수채화"]
  },
  {
    no : 3,
    name : "팔공산 벚꽃축제",
    ...
    category : "festival",
    charater : ["벚꽃터널", "대표축제", "암벽등반 체험", "동화사", "4월중"]
  },
  {
    no : 4,
    name : "대구국제뮤지컬페스티벌",
    ...
    category : "festival",
    charater : ["K-Musical", "여름", "세계 뮤지컬 소개", "6~7월중", "볼거리"]
  },
  {
    no : 5,
    name : "대구치맥페스티벌",
    ...
    category : "festival",
    charater : ["치킨과 맥주", "시식", "무대행사", "전시행사", "7월중"]
  },
  {
    no : 6,
    name : "파워풀대구페스티벌마당",
    ...
    category : "festival",
    charater : ["열정", "빨강", "컬러풀퍼레이드", "거리예술제", "7월중"]
  }
];
